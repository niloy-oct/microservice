    ...
    private static List<Product> GetPreConfiguredProducts()
    {
        ...
        [
            ...
            new Product()
            {
                ...
                Summary =
                    "Lenovo IdeaPad Slim 3i 15ITL Intel Core i3 1005G1 4GB Ram 256GB SSD 15.6 Inch FHD Display Platinum Grey Laptop.",
                Description =
            ...
            new Product()
            {
                ...
                Name = "Xiaomi Mi 9",
                Summary =
                    "Xiaomi Mi 9 SE Cell Phone Snapdragon 712 Android Fingerprint Global Version Original Smartphone.",
                Description =
                    "The sources of all brand products sold in this store include: brand counter display machines, end-of-stock clearance machines, sample machines, etc. Because we need to update it to the global version, there will be some scratches or abrasions, please consider it carefully before you purchase the order.",
            ...
            new Product()
            {
                ...
                Summary =
                    "Vinyl Stickers for DELL Inspiron 7510 7501 7610 7620 5510 Solid Laptop Skin for DELL Inspiron 7420 5310 5418 Decal Film.",
                Description =
                    "The effect picture shows only one model. Please place an order according to your specific model, not just the picture.2. If you are not sure of your laptop model, please contact customer service.",
